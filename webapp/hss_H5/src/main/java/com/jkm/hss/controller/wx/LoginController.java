...
//        }
    ...
    public String bankBranch(final HttpServletRequest request, final HttpServletResponse response,final Model model,@PathVariable("bankId") Long bankId,@PathVariable("source") Integer source) throws IOException {
