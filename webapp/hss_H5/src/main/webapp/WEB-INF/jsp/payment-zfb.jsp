...
<head>
  ...
  <script>
      ...
      function aysnLoadcb () {
          ...
          script.src = "http://static.jinkaimen.cn/hss/2.2.33/payment.min.js";
          script.type = "text/javascript";
          document.head.appendChild(script);
          script.onerror = function () {
              var script = document.createElement('script');
              script.src = '/js/hss/2.2.33/payment.min.js';
              script.type = "text/javascript";
              document.head.appendChild(script);
          }
      }
...
<script src="http://static.jinkaimen.cn/hss/2.2.33/payment.min.js"></script>--%>
</html>