  ...
  <script>
      function aysnLoadCss(url,cburl) {
          ...
          link.onload = function () {
              document.getElementById('payment-zfb').style.opacity='1'
          }
      }
      function aysnLoadcb () {
          var script = document.createElement('script');
          script.src = "http://static.jinkaimen.cn/hss/2.2.31/payment.min.js";
          script.type = "text/javascript";
          document.head.appendChild(script);
          script.onerror = function () {
              var script = document.createElement('script');
              script.src = '/js/hss/2.2.31/payment.min.js';
              script.type = "text/javascript";
              document.head.appendChild(script);
          }
      }
...
<div id="payment-zfb" style="opacity:0">
  <div class="space">
    <div class="prompt">
...
<script src="http://static.jinkaimen.cn/hss/2.2.31/payment.min.js"></script>--%>
</html>