...
<head>
  ...
  <script>
      ...
      function aysnLoadcb () {
          ...
          script.src = "http://static.jinkaimen.cn/hss/2.2.33/hasAccount.min.js";
          script.type = "text/javascript";
          document.head.appendChild(script);
          script.onerror = function () {
              var script = document.createElement('script');
              script.src = '/js/hss/2.2.33/hasAccount.min.js';
              script.type = "text/javascript";
              document.head.appendChild(script);
          }
      }
...
<div id="account" style="opacity: 0">
  <div class="account">
    <div class="logo"></div>
...
<script src="http://static.jinkaimen.cn/hss/2.2.33/hasAccount.min.js"></script>--%>
</html>
