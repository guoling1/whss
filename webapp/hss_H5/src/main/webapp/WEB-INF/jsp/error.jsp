...
<div id="error">
  ...
  <div class="qa">
    ...
    <div class="qa-group">
      ...
      <div class="a">您关闭该信用卡的快捷支付功能，或者未开通。具体可以询问您的发卡银行“为什么我不能进行快捷支付付款”</div>
    </div>
    <div class="qa-group">
      <div class="q"><span></span>“手机号或CVN输入不正确”</div>
      <div class="a">您必须输入开通此银行卡是预留在银行的手机号。CVN码是信用卡背面印刷的数字的最后3位，请参考示例图输入。</div>
    </div>
  </div>
</div>
...
<script src="http://static.jinkaimen.cn/hss/2.2.26/common.min.js"></script>
</html>
