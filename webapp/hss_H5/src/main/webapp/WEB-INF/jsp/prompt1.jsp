...
<head>
  ...
  <script>
      ...
      function aysnLoadcb () {
          ...
          script.src = "http://static.jinkaimen.cn/hss/2.2.33/common.min.js";
          script.type = "text/javascript";
          document.head.appendChild(script);
          script.onerror = function () {
              var script = document.createElement('script');
              script.src = '/js/hss/2.2.33/common.min.js';
              script.type = "text/javascript";
              document.head.appendChild(script);
          }
      }
...
<div id="prompt" style="opacity: 0">
  ...
  <p>请耐心等待</p>
  <a href="/sqb/wallet?oemNo=${oemNo}" class="btn">返回首页</a>
</div>
</body>
<%--<script src="http://static.jinkaimen.cn/vendor/vendor.1.0.9.13.min.js"></script>--%>
<%--<script src="http://static.jinkaimen.cn/hss/2.2.33/common.min.js"></script>--%>
</html>