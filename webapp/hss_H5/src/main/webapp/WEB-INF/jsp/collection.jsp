...
<head>
  ...
  <link rel="stylesheet" href="/css/hss/style.2.2.10.css">
...
<%--<script src="http://static.jinkaimen.cn/hss/2.2.16/collection.min.js"></script>--%>
<script src="/js/hss/2.2.16/collection.min.js"></script>
</html>