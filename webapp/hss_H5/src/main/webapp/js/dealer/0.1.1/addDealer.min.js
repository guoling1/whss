...
submit.addEventListener('click', function () {
  ...
  }) && validate.name(username.value, '代理商姓名') && validate.address(belongArea.value, '代理商所在地') && validate.name(bankAccountName.value, '银行开户名') && validate.empty(alipaySettleRate.value, '支付宝结算费率') && validate.empty(weixinSettleRate.value, '微信结算费率') && validate.empty(quickSettleRate.value, '无卡快捷结算费率') && validate.empty(withdrawSettleFee.value, '提现结算价')) {
