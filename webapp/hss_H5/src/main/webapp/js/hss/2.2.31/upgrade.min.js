...
var isUpBtn = document.getElementById('isUpBtn');
var touchS = 0;
var touchE = 0;
var move = false;
var moveLength = 0;
...
up.addEventListener('touchmove', function (e) {
  ...
  var banner_child = banner.getElementsByClassName('list');
  if (touchE - 50 > touchS && !move) {
    if (banner_child[moveLength - 1].className == 'list active') return;
    move = true;
    for (var b = 0; b < banner_child.length; b++) {
    ...
    move = true;
    for (var _b = 0; _b < banner_child.length; _b++) {
      switch (banner_child[_b].className) {
        case 'list active':
          banner_child[_b].className = 'list left';
          break;
        case 'list left':
          banner_child[_b].className = 'list left none';
          break;
        case 'list right':
          banner_child[_b].className = 'list active';
          break;
        case 'list right none':
          banner_child[_b].className = 'list right';
          break;
      }
    }
    setTimeout(function () {
...
http.post('/wx/toUpgrade', {}, function (data) {
  ...
  var _loop = function _loop(i) {
    ...
    switch (data.upgradeRules[i].type) {
      case 3:
        boss_banner_list = document.createElement('div');

        boss_banner_list.className = 'list active';
        boss_banner_head = document.createElement('div');

        boss_banner_head.className = 'head boss';
        boss_banner_text = document.createElement('div');

        boss_banner_text.className = 'text';
        boss_banner_text.innerHTML = '老板';
        boss_banner_type = document.createElement('ul');

        boss_banner_type.className = 'upType';
        //li 1
        boss_banner_type_li1 = document.createElement('li');
        ...
        boss_banner_type_li1_left = document.createElement('div');

        boss_banner_type_li1_left.className = 'left';
        boss_banner_type_li1_span1 = document.createElement('span');

        boss_banner_type_li1_span1.className = 'check active';
        boss_banner_type_li1_span2 = document.createElement('span');
        ...
        //li 2
        boss_banner_type_li2 = document.createElement('li');
        ...
        boss_banner_type_li2_left = document.createElement('div');

        boss_banner_type_li2_left.className = 'left';
        boss_banner_type_li2_span1 = document.createElement('span');

        boss_banner_type_li2_span1.className = 'check';
        boss_banner_type_li2_span2 = document.createElement('span');
        ...
        boss_banner_bottom = document.createElement('div');
        ...
        break;
      case 2:
        manager_banner_list = document.createElement('div');

        manager_banner_list.className = 'list left';
        manager_banner_head = document.createElement('div');

        manager_banner_head.className = 'head manager';
        manager_banner_text = document.createElement('div');

        manager_banner_text.className = 'text';
        manager_banner_text.innerHTML = '店长';
        manager_banner_type = document.createElement('ul');

        manager_banner_type.className = 'upType';
        //li 1
        manager_banner_type_li1 = document.createElement('li');
        ...
        manager_banner_type_li1_left = document.createElement('div');

        manager_banner_type_li1_left.className = 'left';
        manager_banner_type_li1_span1 = document.createElement('span');

        manager_banner_type_li1_span1.className = 'check active';
        manager_banner_type_li1_span2 = document.createElement('span');
        ...
        //li 2
        manager_banner_type_li2 = document.createElement('li');
        ...
        manager_banner_type_li2_left = document.createElement('div');

        manager_banner_type_li2_left.className = 'left';
        manager_banner_type_li2_span1 = document.createElement('span');

        manager_banner_type_li2_span1.className = 'check';
        manager_banner_type_li2_span2 = document.createElement('span');
        ...
        manager_banner_bottom = document.createElement('div');
        ...
        break;
      case 1:
        assistant_banner_list = document.createElement('div');

        assistant_banner_list.className = 'list left none';
        assistant_banner_head = document.createElement('div');

        assistant_banner_head.className = 'head assistant';
        assistant_banner_text = document.createElement('div');

        assistant_banner_text.className = 'text';
        assistant_banner_text.innerHTML = '店员';
        assistant_banner_type = document.createElement('ul');

        assistant_banner_type.className = 'upType';
        //li 1
        assistant_banner_type_li1 = document.createElement('li');
        ...
        assistant_banner_type_li1_left = document.createElement('div');

        assistant_banner_type_li1_left.className = 'left';
        assistant_banner_type_li1_span1 = document.createElement('span');

        assistant_banner_type_li1_span1.className = 'check active';
        assistant_banner_type_li1_span2 = document.createElement('span');
        ...
        //li 2
        assistant_banner_type_li2 = document.createElement('li');
        ...
        assistant_banner_type_li2_left = document.createElement('div');

        assistant_banner_type_li2_left.className = 'left';
        assistant_banner_type_li2_span1 = document.createElement('span');

        assistant_banner_type_li2_span1.className = 'check';
        assistant_banner_type_li2_span2 = document.createElement('span');
        ...
        assistant_banner_type_li2_right = document.createElement('div');
        ...
        assistant_banner_type_li2_small = document.createElement('div');
        ...
        assistant_banner_bottom = document.createElement('div');
  ...
  for (var i = 2; i > nowLevel - 1; i--) {
    var boss_banner_list;
    var boss_banner_head;
    var boss_banner_text;
    var boss_banner_type;
    var boss_banner_type_li1;
    var boss_banner_type_li1_left;
    var boss_banner_type_li1_span1;
    var boss_banner_type_li1_span2;
    var boss_banner_type_li1_right;
    var boss_banner_type_li1_small;
    var boss_banner_type_li2;
    var boss_banner_type_li2_left;
    var boss_banner_type_li2_span1;
    var boss_banner_type_li2_span2;
    var boss_banner_type_li2_right;
    var boss_banner_type_li2_small;
    var boss_banner_bottom;
    var manager_banner_list;
    var manager_banner_head;
    var manager_banner_text;
    var manager_banner_type;
    var manager_banner_type_li1;
    var manager_banner_type_li1_left;
    var manager_banner_type_li1_span1;
    var manager_banner_type_li1_span2;
    var manager_banner_type_li1_right;
    var manager_banner_type_li1_small;
    var manager_banner_type_li2;
    var manager_banner_type_li2_left;
    var manager_banner_type_li2_span1;
    var manager_banner_type_li2_span2;
    var manager_banner_type_li2_right;
    var manager_banner_type_li2_small;
    var manager_banner_bottom;
    var assistant_banner_list;
    var assistant_banner_head;
    var assistant_banner_text;
    var assistant_banner_type;
    var assistant_banner_type_li1;
    var assistant_banner_type_li1_left;
    var assistant_banner_type_li1_span1;
    var assistant_banner_type_li1_span2;
    var assistant_banner_type_li1_right;
    var assistant_banner_type_li1_small;
    var assistant_banner_type_li2;
    var assistant_banner_type_li2_left;
    var assistant_banner_type_li2_span1;
    var assistant_banner_type_li2_span2;
    var assistant_banner_type_li2_right;
    var assistant_banner_type_li2_small;
    var assistant_banner_bottom;
