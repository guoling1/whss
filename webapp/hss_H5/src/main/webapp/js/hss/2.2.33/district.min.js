...
var data = localStorage.getItem('branch');
console.log(data);
if (data != '' && data != null) {
...
submit.onclick = function () {
    if (validate.empty(pageData.provinceCode, '所在地区') && validate.empty(pageData.provinceName, '所在地区') && validate.empty(pageData.cityCode, '所在地区') && validate.empty(pageData.cityName, '所在地区') && validate.empty(pageData.countyCode, '所在地区') && validate.empty(pageData.countyName, '所在地区')) {
