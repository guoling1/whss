...
// 处理 初始化 的过程
if (pageData.provinceCode != '' && pageData.provinceName != '' && pageData.cityCode != '' && pageData.cityName != '' && pageData.countyCode != '' && pageData.countyName != '' && pageData.branchName != '') {
  world.value = pageData.provinceName + pageData.cityName + pageData.countyName;
  select.innerHTML = pageData.branchName;
  select.style.fontSize = '15px';
  select.style.color = '#000';
  var branchStorage = JSON.parse(localStorage.getItem('branch'));
...
submit.onclick = function () {
  ...
  if (validate.empty(pageData.provinceCode, '所在地区') && validate.empty(pageData.provinceName, '所在地区') && validate.empty(pageData.cityCode, '所在地区') && validate.empty(pageData.cityName, '所在地区') && validate.empty(pageData.countyCode, '所在地区') && validate.empty(pageData.countyName, '所在地区') && validate.empty(pageData.branchName, '支行信息')) {
