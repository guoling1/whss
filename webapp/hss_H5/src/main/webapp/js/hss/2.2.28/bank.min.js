...
var HasBank = function HasBank(bin) {
...
var getBankList = function getBankList() {
  http.post('/wx/myCardList', {}, function (data) {
    ...
    var _loop = function _loop(i) {
      ...
      var index = HasBank(data[i].bankBin);
      if (index != -1) {
...
getBankList();
//# sourceMappingURL=bank.min.js.map
