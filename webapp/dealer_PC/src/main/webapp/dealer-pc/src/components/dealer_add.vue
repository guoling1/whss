            ...
            <div class="box-body">
              ...
              <el-form ref="form" :model="form" :rules="rules" label-width="120px" class="demo-ruleForm">
                ...
                <el-form-item label="省市区域" prop="belongCityCode">
                  <el-col :span="10">
                    <el-select v-model="form.belongProvinceCode" placeholder="请选择" @change="province_select">
                  ...
                  <el-col :span="10">
                    <el-select v-model="form.belongCityCode" placeholder="请选择" @change="city_select">
