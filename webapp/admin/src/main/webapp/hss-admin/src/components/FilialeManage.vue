<template>
  <div id="filialeManage">
    <div class="col-md-12">
      <div class="box" style="margin-top:15px;overflow: hidden;min-height: 500px">
        <div class="box-header">
          <h3 class="box-title">分公司管理</h3>
          <el-button type="text" @click="addFiliale">新增分公司</el-button>
        </div>
        <div class="box-body">
          <ul class="search">
            <li class="same">
         ...
         <!-- <el-table v-loading.body="loading" style="font-size: 12px;margin-bottom: 15px;" :data="records" border>
            ...
            <el-table-column prop="appId" label="分公司简称" min-width="85"></el-table-column>
            ...
            <el-table-column prop="appId" label="好收收" min-width="85"></el-table-column>
            <el-table-column prop="appId" label="好收银" min-width="85"></el-table-column>
          </el-table>-->
