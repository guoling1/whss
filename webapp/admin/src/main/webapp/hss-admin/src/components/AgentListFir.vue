          ...
          <el-table v-loading.body="loading"  style="font-size: 12px;margin:15px 0" :data="records" border >
            <el-table-column label="代理商名称">
              <template scope="scope">
                <router-link target="_blank" :to="'/admin/agentAddBase?id='+records[scope.$index].id">{{records[scope.$index].proxyName}}</router-link>
              </template>
            </el-table-column>
            <el-table-column label="代理商编号">
              <template scope="scope">
                <router-link :to="'/admin/agentAddBase?id='+records[scope.$index].id">{{records[scope.$index].markCode}}</router-link>
              </template>
            </el-table-column>
