...
//        this.$router.push({path:'/admin/record/agentAddPro',query:{dealerId:id,productId:productId,product:val}});
      ...
      configureGateway:function (id,productId,proxyName,markCode) {
        window.open('http://admin.qianbaojiajia.com/admin/details/gateway?id='+id+'&productId='+productId+'&proxyName='+proxyName+'&markCode='+markCode)
      }
    }
  }
</script>
