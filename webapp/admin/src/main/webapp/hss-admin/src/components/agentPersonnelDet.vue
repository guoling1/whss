        ...
        <div class="">
          <div class="table-responsive">
            ...
            <el-row type="flex" class="row-bg" justify="center">
              ...
              <el-col :span="8">
                <div class="grid-content bg-purple-light">
                  <el-button v-if="!isShow" type="text" @click="_$power(function(){dialogFormVisible = true},'boss_dealer_staff_updatepwd')" style="margin-left: 15px">修改密码</el-button>
                </div>
              </el-col>
            </el-row>
            <!--修改密码-->
          ...
          <el-col :span="6">
            <div class="grid-content bg-purple-light" style="width: 100%">
              ...
              <div class="btn btn-primary" @click="create" v-if="isShow"
                   style="width: 100%;margin: 20px 0 100px;">
                创 建 员 工
              </div>
...
//              this.$router.push('/admin/record/personnelList')
      ...
      goBack: function () {
        this.$router.push('/admin/record/agentPersonnel')
      },
      //修改
      upDate: function () {
          this.$http.post('/admin/dealer/updateUser', this.$data.query)
            .then(function (res) {
              this.$store.commit('MESSAGE_ACCORD_SHOW', {
                text: '修改成功'
              })
