<template lang="html">
  <div id="firProfit">
    <div style="padding: 8px 30px; background: rgb(243, 156, 18); z-index: 999999; font-size: 22px; font-weight: 600;margin-bottom: 15px;    color: #fff;">一级代理商分润</div>
              ...
              <div class="col-sm-12">
                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                  ...
                  <tr role="row">
                    ...
                    <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">一级代理商名称
                    </th>
                  ...
                  <tr role="row" v-for="(record,index) in $$records">
                    ...
                    <td><router-link :to="{path:'/admin/record/firProfitDet',query:{id:record.id}}" class="btn btn-success" v-if="record.totalMoney!=0">查看明细</router-link></td>
                  </tr>
                  </tbody>
                </table>
              </div>
