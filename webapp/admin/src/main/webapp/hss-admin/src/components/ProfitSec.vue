      ...
      <div class="box" style="margin-top:15px;overflow: hidden">
        ...
        <div class="box-body">
          ...
          <el-table v-loading.body="loading" style="font-size: 12px;margin:15px 0" :data="records" border>
            ...
            <el-table-column prop="dealerName" label="二级代理商名称"></el-table-column>
            ...
            <el-table-column label="操作" width="100">
              <template scope="scope">
                <router-link :to="{path:'/admin/record/secProfitDet',query:{id:records[scope.$index].id}}" v-if="records[scope.$index].totalMoney!=0" type="text" size="small">明细
                </router-link>
              </template>
            </el-table-column>
          </el-table>
...
<script lang="babel">
  export default{
    ...
    created: function () {
      this.$http.post('/admin/profit/secondProfit', this.$data.query)
        .then(function (res) {
