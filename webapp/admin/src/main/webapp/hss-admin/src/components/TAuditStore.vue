      ...
      <div class="box" style="overflow: hidden">
        ...
        <div class="box-body">
          ...
          <ul class="search">
            <li class="same">
              <label>结算日期:</label>
              <el-date-picker style="width: 193px" v-model="date" size="small" type="daterange" align="right" placeholder="选择日期范围" :picker-options="pickerOptions" :clearable="false" :editable="false"></el-date-picker>
            </li>
            <li class="same">
              <label>结算单号:</label>
