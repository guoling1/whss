...
public class UpgradeController extends BaseController {
    ...
    @Autowired
    private HsyPartnerRulesService hsyPartnerRulesService;
    ...
    public CommonResponse add(@RequestBody final UpgradeRequest req) {
        ...
        if((EnumProductType.HSY.getId()).equals(productOptional.get().getType())){
            ...
            if(hsyPartnerRules==null){
                hsyPartnerRules = new HsyPartnerRules();
                hsyPartnerRules.setOemProfit(new BigDecimal("0"));
                hsyPartnerRules.setFirstDealerProfit(new BigDecimal("0"));
                hsyPartnerRules.setSecondDealerProfit(new BigDecimal("0"));
                hsyPartnerRules.setDirectRecommendProfit(new BigDecimal("0"));
                hsyPartnerRules.setIndirectRecommendProfit(new BigDecimal("0"));
                hsyPartnerRules.setBaodanProfit(new BigDecimal("0"));
            }else{
                hsyPartnerRules.setOemProfit(hsyPartnerRules.getOemProfit().multiply(new BigDecimal("100")).setScale(2));
                hsyPartnerRules.setFirstDealerProfit(hsyPartnerRules.getFirstDealerProfit().multiply(new BigDecimal("100")).setScale(2));
                hsyPartnerRules.setSecondDealerProfit(hsyPartnerRules.getSecondDealerProfit().multiply(new BigDecimal("100")).setScale(2));
                hsyPartnerRules.setDirectRecommendProfit(hsyPartnerRules.getDirectRecommendProfit().multiply(new BigDecimal("100")).setScale(2));
                hsyPartnerRules.setIndirectRecommendProfit(hsyPartnerRules.getIndirectRecommendProfit().multiply(new BigDecimal("100")).setScale(2));
                hsyPartnerRules.setBaodanProfit(hsyPartnerRules.getBaodanProfit().multiply(new BigDecimal("100")).setScale(2));
            }
            return CommonResponse.objectResponse(1, "success", hsyPartnerRules);
        }else{
            //商户升级规则设置
    ...
    public CommonResponse addOrUpdate(@RequestBody final UpgradeAndRecommendRequest req) {
        ...
        if((EnumProductType.HSY.getId()).equals(productOptional.get().getType())){
            ...
            hp.setIndirectRecommendProfit(req.getHsyPartnerRules().getIndirectRecommendProfit().divide(b1));
            hp.setDirectRecommendProfit(req.getHsyPartnerRules().getDirectRecommendProfit().divide(b1));
            hp.setBaodanProfit(req.getHsyPartnerRules().getBaodanProfit().divide(b1));
            if(hsyPartnerRules==null){
