  ...
  <div class="keyboard" id="keyboard">
    <div class="copyright">
      <div <c:if test="${appPolicyMember==null}">style="display:none;"</c:if> >
        ...
        <a class="weui-btn weui-btn_mini weui-btn_primary" href="/sqb/toRecharge?mid=${appPolicyMember.id}&source=ZFB">充值</a>
        </c:if>
      </div>
    </div>
    ...
    <div class="keys">
      ...
      <div class="zfb">
        ...
        <%--非会员--%>
        <div class="pay" keyCtrl="ali-pay" <c:if test="${appPolicyMember!=null}">style="display:none;"</c:if>>
          付款
        </div>
      </div>
    </div>
...
<script src="http://static.jinkaimen.cn/hsy/js/2.0.2.1/payment.min.js"></script>
</html>