...
<div id="rechargeResults">
  ...
  <a class="toRecord" href="<%=basePath%>membership/toRechargeList?mid=${mid}" style="padding-bottom: 10px">查看充值记录</a>
  <a class="toRecord" href="<%=basePath%>membership/memberInfo?mid=${mid}&source=${source}" style="display: block;padding-top: 0;">查看会员卡详情</a>
