...
public enum EnumPayChannelSign {
     ...
     * 会员卡支付
     */
    MEMBER(1201, "member_card", EnumPaymentChannel.MEMBER_PAY, "会员卡", EnumUpperChannel.MEMBER, false, EnumBalanceTimeType.T1, false),
...
//    YIJIA_ALIPAY(502, "yijia_alipay", "支付宝", "溢+支付宝", EnumUpperChannel.YIJIA, false)
     ...
     * 民生微信
     */
    MS_WECHAT_T1(701, "xmms_wechat_t1", EnumPaymentChannel.WECHAT_PAY, "厦门民生微信", EnumUpperChannel.XMMS_BANK, false, EnumBalanceTimeType.T1, true),
    /**
     * 民生支付宝
     */
    MS_ALIPAY_T1(702, "xmms_alipay_t1", EnumPaymentChannel.ALIPAY, "厦门民生支付宝", EnumUpperChannel.XMMS_BANK, false, EnumBalanceTimeType.T1, true),
    /**
     * 民生微信
     */
    MS_WECHAT_D0(703, "xmms_wechat_d0", EnumPaymentChannel.WECHAT_PAY, "厦门民生微信", EnumUpperChannel.XMMS_BANK, false, EnumBalanceTimeType.D0, true),
    /**
     * 民生支付宝
     */
    MS_ALIPAY_D0(704, "xmms_alipay_d0", EnumPaymentChannel.ALIPAY, "厦门民生支付宝", EnumUpperChannel.XMMS_BANK, false, EnumBalanceTimeType.D0, true),
