...
public class DealerWithdrawServiceImpl implements DealerWithdrawService {
    ...
    public Pair<Integer, String> withdraw(long accountId, String totalAmount, int channel, String appId, BigDecimal withdrawFee) {
        channel = EnumPayChannelSign.MB_UNIONPAY_DO.getId();
        ...
        if (playMoneyOrder.isWithDrawing()) {
            ...
            paymentSdkDaiFuRequest.setPlayMoneyChannel(EnumUpperChannel.MOBAO.getId());
    ...
    private void markWithdrawSuccess(final long orderId, final long accountId,
        ...
        if (order.isWithDrawing()) {
            ...
            accountFlow.setAccountId(AccountConstants.DEALER_POUNDAGE_ACCOUNT_ID);
