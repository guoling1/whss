...
public class WxConstants {
    ...
    public final static String WEIXIN_USERINFO_NEW="https://open.weixin.qq.com/connect/oauth2/authorize?appid="+APP_ID+"&redirect_uri=http%3a%2f%2f"+DOMAIN+"%2fpage%2ftoSkip&response_type=code&scope=snsapi_base&state=";
