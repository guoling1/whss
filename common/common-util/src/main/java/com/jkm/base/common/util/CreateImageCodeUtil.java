...
public class CreateImageCodeUtil {
    ...
    private static CreateImageCodeUtil createImageCodeUtil;
    /**
     * 通过默认构造初始化参数
     */
    private CreateImageCodeUtil(){
        width=100;
        height=30;
     ...
     * @return
     */
    public static CreateImageCodeUtil getInstance(){
        if(createImageCodeUtil==null){
            createImageCodeUtil=new CreateImageCodeUtil();
        }
        return createImageCodeUtil;
    }
    ...
    public void setCreateImageCodeUtil(Integer width,Integer height,Integer num,String code){
        this.width=width;
        this.height=height;
        this.num=num;
        this.code=code;
    }
    public void setCreateImageCodeUtil(Integer width,Integer height,String code){
        this.width=width;
        this.height=height;
        this.code=code;
    }
